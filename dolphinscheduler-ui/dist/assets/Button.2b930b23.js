import{l as O,d as ee,$ as Se,X as Be,r as B,U as Te,a2 as Pe,h as p,k as b,W as ke,ai as oe,V as Re,n as g,p as l,_ as Y,aj as He,e as re,a0 as Ee,S as Oe,g as R,b as je,f as Ie,t as De,ak as Fe,al as Ne,O as _e,a7 as Ke,j as r,ad as H}from"./index.291055ec.js";import{i as j}from"./is-browser.45c3bd93.js";import{u as Me,c as J}from"./use-form-item.5072a1b6.js";import{r as Z,i as Ge}from"./resolve-slot.9ff69768.js";import{c as Ve}from"./call.00499c7e.js";const We=O("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),qe=ee({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){Se("-base-wave",We,Be(e,"clsPrefix"));const f=B(null),h=B(!1);let u=null;return Te(()=>{u!==null&&window.clearTimeout(u)}),{active:h,selfRef:f,play(){u!==null&&(window.clearTimeout(u),h.value=!1,u=null),Pe(()=>{var v;(v=f.value)===null||v===void 0||v.offsetHeight,h.value=!0,u=window.setTimeout(()=>{h.value=!1,u=null},1e3)})}}},render(){const{clsPrefix:e}=this;return p("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:C}=ke;function Qe({duration:e=".2s",delay:f=".1s"}={}){return[b("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),b("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 ...
 margin-left ${e} ${C},
 margin-right ${e} ${C};
 `)]}const Ae=j&&"chrome"in window;j&&navigator.userAgent.includes("Firefox");const Xe=j&&navigator.userAgent.includes("Safari")&&!Ae;function $(e){return oe(e,[255,255,255,.16])}function E(e){return oe(e,[0,0,0,.12])}const Le=Re("n-button-group"),Ue=b([O("button",`
 margin: 0;
 ...
 `,[g("active",{zIndex:1,animationName:"button-wave-spread, button-wave-opacity"})]),j&&"MozBoxSizing"in document.createElement("div").style?b("&::moz-focus-inner",{border:0}):null,l("border, state-border",`
 position: absolute;
 left: 0;
 top: 0;
 right: 0;
